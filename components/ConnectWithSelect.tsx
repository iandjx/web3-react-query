...
import { useWeb3React } from '../../core/src/provider';
...
export function ConnectWithSelect({
  ...
  connector: MetaMask | WalletConnect | CoinbaseWallet | Network | GnosisSafe | EIP1193
  ...
  if (error) {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <button
          onClick={() => {
            console.log(connector.deactivate)
            console.log(connector.resetState)
